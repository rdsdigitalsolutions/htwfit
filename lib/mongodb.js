...
export async function migrateUser(collection) {
    const data = [
        { id: uuidv4(), name: 'Test Doe', email: 'test@testing.com', password: 'rSnsw8mD5YEb', image: 'test_profile_picture.jpeg', created: moment().format(), update: null, deleted: null },
        { id: uuidv4(), name: 'Jhoe Doe', email: 'jhoedoe@gmail.com', password: 'rSnsw8mD5YEb', image: 'test_profile_picture.jpeg', created: moment().format(), update: null, deleted: null },
        { id: uuidv4(), name: 'Marie Doe', email: 'mariedoe@gmail.com', password: 'rSnsw8mD5YEb', image: 'test_profile_picture.jpeg', created: moment().format(), update: null, deleted: null },
    ];
